...
function DiskusnyStanDesktop(){

    return (
        <div>
            <div className="row">
                <div className="columnDisc discLeft">
            ...
            <div className="row" style={{alignItems: 'stretch'}}>
                <div className="columnDisc discRight">
...
export default DiskusnyStanDesktop